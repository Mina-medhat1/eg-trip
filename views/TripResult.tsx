...
import { Clock, MapPin, Trash2, Edit2, Plus, Download, Share2, Calendar, DollarSign, ArrowRight, Plane } from "lucide-react";
  ...
  return (
    <div className="bg-gray-50 dark:bg-navy min-h-screen font-sans pb-20 transition-colors duration-300">
              ...
              <div className="animate-fade-in-up">
                  ...
                  <div className="flex flex-wrap items-center gap-6 text-sm font-medium opacity-90">
                      <span className="flex items-center bg-white/10 px-3 py-1.5 rounded-lg backdrop-blur-sm border border-white/10">
                          <Clock className="w-4 h-4 mr-2 text-orange"/> {plan.days.length} Days
                      </span>
                      <span className="flex items-center bg-white/10 px-3 py-1.5 rounded-lg backdrop-blur-sm border border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 -mt-10 relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
         ...
         {/* 2. LEFT COLUMN: Itinerary Timeline */}
         <div className="lg:col-span-2 space-y-8">
              {plan.days.map((day) => (
                  <div key={day.dayNumber} className="bg-white dark:bg-slate-800 rounded-3xl p-6 md:p-8 shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-slate-700">
                      {/* Day Header */}
                      ...
                      {/* Timeline Items */}
                      <div className="space-y-10 relative pl-8 border-l-2 border-dashed border-gray-200 dark:border-slate-700 ml-3">
                           {day.schedule.map((act, i) => (
                               <div key={i} className="relative group">
                                    ...
                                    {/* Activity Card */}
                                    <div className="bg-white dark:bg-slate-700/50 hover:bg-orange/5 dark:hover:bg-orange/5 transition-all rounded-2xl p-4 border border-gray-100 dark:border-slate-600 hover:border-orange/20 dark:hover:border-orange/20 shadow-sm hover:shadow-md group">
         ...
         {/* 3. RIGHT COLUMN: Sidebar (Journal Style) */}
